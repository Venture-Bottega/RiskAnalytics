const INDICATORS = [
    { key: 'seismicHazard',          label: 'Seismic Hazard',        color: '#c0392b', invert: false },
    { key: 'floodLandslide',         label: 'Flood / Landslide',     color: '#2980b9', invert: false },
    { key: 'wildfireExposure',       label: 'Wildfire Exposure',     color: '#e67e22', invert: false },
    { key: 'populationVulnerability',label: 'Pop. Vulnerability',    color: '#8e44ad', invert: false },
    { key: 'emergencyCoverage',      label: 'Emergency Coverage',    color: '#27ae60', invert: false },
]
    ...
    return (
        <div style={{
            ...
            <div style={{ padding: '12px 16px' }}>
                {INDICATORS.map(({ key, label, color, invert }) => {
                    ...
                    // invert: true means lower score is better (e.g. imperviousness)
                    const winner = invert
