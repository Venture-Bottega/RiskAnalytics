...
const INDICATORS = [
    {
        ...
        color: '#c0392b',
        note: 'Zone 1 = highest risk → high score',
        defaultNote: 'Highest structural weight — seismic zone classification directly reflects long-term hazard. Zone 1 municipalities face the most severe earthquake risk.',
    },
    {
        key: 'flood',
        label: 'Flood / Landslide',
        color: '#2980b9',
        note: '% population and area at high hydraulic/landslide risk',
        defaultNote: 'Heaviest weight — flood and landslide risk affects the most people across Central Italy, especially in hilly and coastal terrains.',
    },
    {
        key: 'wildfire',
        label: 'Wildfire Exposure',
        color: '#e67e22',
        note: 'Hectares burned since 2016 (EFFIS)',
        defaultNote: 'Moderate weight — historical burned area is a strong proxy for future wildfire risk in Mediterranean climates.',
    },
    {
        key: 'vuln',
        label: 'Population Vulnerability',
        color: '#8e44ad',
        note: 'Elderly population share (>64 years)',
        defaultNote: 'Strong weight — elderly residents face higher mortality and mobility challenges in any emergency event.',
    },
    {
        key: 'infra',
        label: 'Emergency Coverage',
        color: '#27ae60',
        note: 'Inverse hospital density (low coverage = high risk)',
        defaultNote: 'Lower weight — hospital availability is important but partially compensated by regional response networks.',
    },
]
            ...
            {open && (
                <div style={{
                    ...
                    {!isDefault && (
                        ...
                        >↺ Reset to defaults (25 / 30 / 15 / 20 / 10)</button>
                    )}
                    ...
                    <div style={{ fontSize: '10px', color: 'var(--color-text-tertiary)', lineHeight: 1.5, marginTop: '8px', fontStyle: 'italic' }}>
                        These defaults reflect the Italian national civil protection risk weighting approach, balancing structural hazard with population exposure. Adjust to reflect your agency's priorities.
                    </div>
                </div>
            )}
        </div>
