        ...
        <div className="rank-list">
            ...
            <div className="rank-list__header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                    ...
                    <div className="rank-list__subtitle">Italy — Civil Protection Priority ranking</div>
                </div>
                <button
                    onClick={onCollapse}
            ...
            <div className="rank-controls">
                <div className="rank-controls__sort">
                    <button className={`rank-controls__sort-btn${sortDir === 'desc' ? ' active' : ''}`} onClick={() => setSortDir('desc')}>↓ Highest risk</button>
                    <button className={`rank-controls__sort-btn${sortDir === 'asc' ? ' active' : ''}`} onClick={() => setSortDir('asc')}>↑ Lowest risk</button>
                </div>
                    ...
                    {infraOpen && (
                        <div style={{ marginTop: '12px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            {[
                                ...
                                { label: '🔥 Wildfire (any)', value: 0, set: () => {}, max: 0 },
